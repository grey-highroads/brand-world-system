...
1. `docs/direction-2026-09-09-world-first.md`, the current direction of record.
2. The `README.md` at the repository root, corrected against the live path.
3. `docs/decisions/`, for standing rulings, checking each record's status line.
4. `docs/findings-2026-09-*.md`, which are the most recent evidence about what the pipeline actually does.
