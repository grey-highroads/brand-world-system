...
The first expected records cover the two-workflow separation, the five-layer brand-brain model, policy-driven production modes, and the boundary between shared infrastructure and private client data.
