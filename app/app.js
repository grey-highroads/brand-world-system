  ...
  if (!assets.length) {
    return `
      <div class="reference-section">
        ...
        ${required ? '<p class="field-note" style="margin-top: 6px;">Without a product image the model will invent packaging, which will not match the real product.</p>' : ""}
      </div>
    `;
  }
  ...
  return `
    <div class="reference-section">
      ...
      <div class="reference-list">
        ...
        ${state.lockedAssetId ? '<p class="field-note" style="margin-top: 6px;">This asset stays exact. The prompt carries format-specific protection rules.</p>' : required ? '<p class="field-note" style="margin-top: 6px;">Select a product image before generating.</p>' : ""}
      </div>
    </div>
  `;
}
