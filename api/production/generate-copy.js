  ...
  const kinds = {
    scene: {
      ...
      rules: [
        ...
        "State expression as a physical fact rather than a mood. Where the eyes are pointed, whether the mouth is open or closed, what the hands are doing. Words like natural, candid, effortless, joyful, or unposed describe a feeling you want and give the camera nothing to do.",
        ...
        "Name one thing the frame cuts, and which edge cuts it. A crop is a concrete event. Saying the composition feels unbalanced is not one.",
