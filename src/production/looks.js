...
//
// `behavior`, added 2026-09-10. One sentence per look saying what the medium
// changes about the people and the room: whether subjects face the camera,
// whether they know they are being photographed, the distance the camera
// keeps, the hour it implies. It is the only part of a look the scene writer
// receives. The optical description in `line` compiles into the Capture
// section after the writer is done, and a writer that had it restated it as
// scene prose in every direction from 2026-09-08 on. See
// docs/findings-2026-09-10-writer-behavior-and-meaning.md. Every entry
// carries one, and a test holds it to that.
...
export const LOOKS = {
  film_noir: {
    ...
    behavior:
      "The camera sits low and looks up at people, or high and looks down on them, one hard light throws their shadow onto the wall beside them, and nobody in the frame acknowledges the camera.",
    line:
  ...
  drugstore_flash: {
    ...
    behavior:
      "Subjects face the camera from a few feet away and know they are being photographed, the way people stand for a snapshot at a party or in a kitchen at night.",
    line:
  ...
  color_slide_1975: {
    ...
    behavior:
      "People are outdoors in bright midday sun, squinting or shaded by a hand or a hat brim, and the camera stands back a few paces as someone on the same outing would.",
    line:
  ...
  consumer_negative_dusk: {
    ...
    resolvesFineDetail: false,
    behavior:
      "The hour is dusk, outdoors or in a doorway open to it, people are a few feet from the camera and going about what they were doing, and anything moving will smear.",
    line:
  ...
  large_format_daylight: {
    ...
    behavior:
      "The camera is on a tripod in daylight and the people in the frame are holding still for it, standing or seated where they were placed, aware of the camera and waiting for it.",
    line:
  ...
  neutral: {
    ...
    environment: "agnostic",
    behavior:
      "One person holds the camera's gaze without smiling, from across a room on a long lens, in a room nobody tidied, lit by one light that has a position in the room.",
    line:
  ...
  overcast_editorial: {
    ...
    behavior:
      "People are outdoors under a flat overcast sky, the camera is close enough to fill the frame with a face or a torso, and the subject is aware of the camera and unhurried.",
    line:
  ...
  anamorphic_widescreen: {
    ...
    environment: "agnostic",
    behavior:
      "The camera stays a few feet from its subject with bright point sources somewhere behind them, and the frame is wide, so people are placed across it rather than centered.",
    line:
  ...
  bleach_bypass_90s: {
    ...
    resolvesFineDetail: false,
    behavior:
      "People are close to the camera under whatever overhead light the room has, unposed and unsmiling, and the frame is tight enough that skin fills a lot of it.",
    line:
  ...
  flash_night_street: {
    ...
    behavior:
      "It is after dark on a street, the subject stands a few feet from the camera facing it and composed for it, and everyone else has fallen into the black behind them.",
    line:
  ...
  pushed_bw_reportage: {
    ...
    resolvesFineDetail: false,
    behavior:
      "The camera is close and handheld in whatever light the room or street has, nobody is posing, and people are caught mid-gesture with their attention on something other than the lens.",
    line:
  ...
  saturated_daylight_adventure: {
    ...
    behavior:
      "People are small in the frame and far from the camera, outdoors under a high clear sun with open sky above them, in the middle of an activity and not looking back.",
    line:
  ...
  daylight_street_documentary: {
    ...
    behavior:
      "It is full daylight on a city street, the subject is walking toward the camera from a distance and others pass through the frame mid-stride, nobody stopping for the picture.",
    line:
  ...
  color_negative_daylight: {
    ...
    environment: "agnostic",
    behavior:
      "The camera is handheld and close, in the middle of the day's activity, and the people in the frame carry on with what they were doing rather than turning to it.",
    line:
  ...
  long_lens_distance: {
    ...
    environment: "agnostic",
    behavior:
      "The camera is well back from its subject, across a room or a street, and the person is unaware of it and turned toward what they are doing.",
    line:
  ...
  available_light_interior: {
    ...
    behavior:
      "People are indoors beside a window during the day, close to the camera and turned toward the light rather than toward the lens, in the middle of something unhurried.",
    line:
